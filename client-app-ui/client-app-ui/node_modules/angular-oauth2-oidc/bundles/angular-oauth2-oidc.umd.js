(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common/http'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('angular-oauth2-oidc', ['@angular/core','@angular/common/http','@angular/common','exports', '@angular/core', '@angular/common', '@angular/common/http', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common.http,global.ng.common,global['angular-oauth2-oidc'] = {}, global.ng.core, global.ng.common, global.ng.common.http, global.rxjs, global.rxjs.operators));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, common, http, rxjs, operators) { 'use strict';
...
SystemDateTimeProvider.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SystemDateTimeProvider, factory: function (t) { return SystemDateTimeProvider.ɵfac(t); } });
var ɵSystemDateTimeProvider_BaseFactory = /*@__PURE__*/ ɵngcc0.ɵɵgetInheritedFactory(SystemDateTimeProvider);
...
OAuthModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function OAuthModule_Factory(t) { return new (t || OAuthModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(OAuthModule, { imports: [ɵngcc2.CommonModule] }); })();
